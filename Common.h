...
const int STATE_RUNNING         = 2;  // running, will move to READY
const int STATE_UNKNOWN         = 42;  // 
...
const int CMD_ACCELOFFSET_SET    = (CMD_PARAM +  8); // Accel offset
